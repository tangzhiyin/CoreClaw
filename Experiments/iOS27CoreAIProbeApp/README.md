# iOS 27 Core AI Probe App

Standalone iOS app for visible true-device smoke tests.
...
The app only checks framework and system-model availability. It does not load a custom `.aimodel` yet.
