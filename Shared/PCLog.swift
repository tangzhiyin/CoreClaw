...
// MARK: - CoreClaw Structured Logging
//
...
enum PCLog {
    ...
    private static let logger = Logger(subsystem: "CoreClaw", category: "App")
    private static let debugLogger = Logger(subsystem: "CoreClaw", category: "Debug")
