...
///
/// NOTE: Slimmed to Gemma family only for CoreClaw. Upstream mlx-swift-lm registers ~50
/// model types (Llama, Phi, Qwen, Mistral, DeepSeek, ...). CoreClaw ships Gemma 4 exclusively
...
///
/// NOTE: Slimmed to Gemma family only for CoreClaw. See the comment on LLMTypeRegistry
/// above — CoreClaw registers its own Gemma 4 model type at runtime, and no other
