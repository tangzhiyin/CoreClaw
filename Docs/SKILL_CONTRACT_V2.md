...
Apple's Foundation Models utilities distinguish prompt-based skill activation from instructions-based activation. CoreClaw should mirror that distinction without coupling the contract to one OS version:
