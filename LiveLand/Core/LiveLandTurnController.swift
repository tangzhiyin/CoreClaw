...
protocol LiveLandSleeper: Sendable {
    func sleep(for duration: TimeInterval) async throws
}

struct LiveLandRealSleeper: LiveLandSleeper {
    func sleep(for duration: TimeInterval) async throws {
...
class LiveLandTurnController {
    ...
    private let sleeper: LiveLandSleeper

    // MARK: - Init

    init(sleeper: LiveLandSleeper = LiveLandRealSleeper()) {
