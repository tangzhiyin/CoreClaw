...
@main
struct PhoneAILiveActivityWidgetBundle: WidgetBundle {
    var body: some Widget {
        PhoneAILiveLandActivityWidget()
        PhoneAILiveLandLauncherWidget()
        if #available(iOS 18.0, *) {
            PhoneAILiveLandControlWidget()
        }
    }
}
...
struct PhoneAILiveLandActivityWidget: Widget {
