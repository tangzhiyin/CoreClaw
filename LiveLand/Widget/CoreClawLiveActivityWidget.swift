...
@main
struct CoreClawLiveActivityWidgetBundle: WidgetBundle {
    var body: some Widget {
        CoreClawLiveLandActivityWidget()
        CoreClawLiveLandLauncherWidget()
        if #available(iOS 18.0, *) {
            CoreClawLiveLandControlWidget()
        }
    }
}

let phoneAILiveLandLaunchURL = URL(string: "phoneai://liveland")!
...
struct CoreClawLiveLandActivityWidget: Widget {
