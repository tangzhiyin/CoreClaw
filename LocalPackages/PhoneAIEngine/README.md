...
Clone [tangzhiyin/PhoneAI](https://github.com/tangzhiyin/PhoneAI), then add
`LocalPackages/PhoneAIEngine` as a local package dependency in Xcode.
...
Full API in [`Sources/PhoneAIEngine/PhoneAIEngine.swift`](Sources/PhoneAIEngine/PhoneAIEngine.swift).
