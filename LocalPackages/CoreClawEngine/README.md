...
Clone [tangzhiyin/CoreClaw](https://github.com/tangzhiyin/CoreClaw), then add
`LocalPackages/CoreClawEngine` as a local package dependency in Xcode.
...
Full API in [`Sources/CoreClawEngine/CoreClawEngine.swift`](Sources/CoreClawEngine/CoreClawEngine.swift).
