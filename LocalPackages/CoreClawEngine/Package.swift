...
//
// 三个 target, 都通过 library product `CoreClawEngine` 暴露:
//
//   CoreClawEngine    Swift  Gemma 4 / LiteRT-LM (.litertlm)
//                             deps: CLiteRTLM
...
//                + LocalPackages/CoreClawEngine/patches/ 上游补丁归档。
...
let package = Package(
    ...
    products: [
        .library(name: "CoreClawEngine", targets: ["CoreClawEngine", "MTMDEngine"]),
    ],
    targets: [
        // ───────────────────────────────────────────────────────────
